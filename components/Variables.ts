export const OWNER_EMAIL="teamplus2427@gmail.com"
export const GMAIL_NAME ="shakhbozcompany@gmail.com"
export const GMAIL_PASSWORD="teamplusadmin"
export const ACCESS_TOKEN_SECRET=`dmknfalksdmfq24wlekqerq2ka'sdlmf'adfkla'dfk;l'asd;lfk'ad;lfka'sd'as;ldkf'qw;lke'qwekr
                                  qwpoerqwe\r]kqwper]pqowekrqpowekrqpework[132pok1[po4i1094)(*U!@()*AKSDMFLKASDMA'LSDF
                                  #&!)(@*#!)@#*(!@_#)(*!@_#!@)JPOKLMNHBGHUIJO!@#*(_!@#_!(*@#f;lkalsdkmfasd687q69w34123
                                  41234%$#^&%$&^%$&%&rqew;1@#$$#KLSDFGNS;DFGZ"ASD;LFKA'DS;LKF;'ADSLFKAD;LFDFS;LKA'SLD;`
export const ACCESS_TOKEN_EXPIRED_DURATION = "15s"
export const REFRESH_TOKEN_EXPIRED_DURATION = "1y"
export const TWILIO_ACCOUNT_SID = "AC4a4c2dfcfdafc57f33c5d456dc9226aa"
